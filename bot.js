...
client.user.setGame(`ولــكــم تــو عــرب شــوب`,"https://www.youtube.com/channel/UCLL7O3mTN6ITxeMzxCdrDUw?view_as=subscriber")
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            ...
            رابط سيرفر الدعم الفني : https://discord.gg/enm8uUB
            **`);
